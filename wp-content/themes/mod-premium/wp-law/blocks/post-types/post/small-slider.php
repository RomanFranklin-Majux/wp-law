<div class="<?php echo $post->css_classes('small-slider') ?>">
		...
		<div class="small-box">
		    ...
		    <?php if ($post->has_thumbnail_image()): ?>
				...
				<a href="<?php echo $post->permalink ?>" title="Read more about <?php echo TMF_Text::limit_chars($post->title, 25) ?>">
					<img class="small-thumbnail" src="<?php echo $logo_1x_url ?>" srcset="<?php echo $high_res ?>" alt="<?php echo $post->thumbnail_image_alt ?>" />
				</a>
			<?php endif; ?>
