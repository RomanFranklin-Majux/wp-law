...
<?php $tmf->block('top')->render() ?>
	...
	<?php $section = $tmf->section('int-billboard') ?>
		<div class="int-billboard-desktop-view">
			<img src="<?php echo $tmf->theme_image('billboard_practice_areas_1x.jpg') ?>" srcset="<?php echo $tmf->theme_image('billboard_practice_areas_2x.jpg') ?> 2x, <?php echo $tmf->theme_image('billboard_practice_areas_3x.jpg') ?> 3x" alt="Personal Injury Lawyers" />
		</div>

		<div class="int-billboard-mobile-view">
			<img src="<?php echo $tmf->theme_image('mobile_int_practice_areas_1x.jpg') ?>" srcset="<?php echo $tmf->theme_image('mobile_int_practice_areas_2x.jpg') ?> 2x, <?php echo $tmf->theme_image('mobile_int_practice_areas_3x.jpg') ?> 3x" alt="Accident Lawyer" />
		</div>
