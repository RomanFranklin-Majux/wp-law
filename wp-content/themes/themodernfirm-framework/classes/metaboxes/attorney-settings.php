...
/**
 * Creates a meta box for attorney settings.
 *
 ...
 */
class TMF_Metabox_AttorneySettings extends TMF_Metabox {

	protected $metabox_name		= 'attorney_settings';
	protected $metabox_title	= 'Attorney Settings';
	...
	public function render() {
		?>
			...
			<?php $this->label('Display Title On Attorney Page', 'show_title') ?><br/><br/>
