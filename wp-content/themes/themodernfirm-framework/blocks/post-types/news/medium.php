<div class="<?php echo $post->css_classes('medium') ?>">
	...
	<?php if ($post->has_thumbnail_image()): ?>
		<a href="<?php echo $post->permalink ?>" title="Read more about <?php echo TMF_Text::limit_chars($post->title, 25) ?>">
			<img class="thumbnail not-mobile" src="<?php echo $post->thumbnail_image_url ?>" alt="<?php echo $post->primary_image_alt ?>" />
		</a>
	<?php endif; ?>
	...
	<div class="excerpt">
		<?php if ($post->has_thumbnail_image()): ?>
			<a href="<?php echo $post->permalink ?>" title="Read more about <?php echo TMF_Text::limit_chars($post->title, 25) ?>">
				<img class="thumbnail mobile" src="<?php echo $post->thumbnail_image_url ?>" alt="<?php echo $post->primary_image_alt ?>" />
			</a>
		<?php endif; ?>
		
		<?php echo $post->excerpt ?>

		<?php if($tmf_option->post_type_news_read_more_links != 1): ?>
	...
	<?php if($tmf_option->post_type_news_read_more_buttons != 1): ?>
