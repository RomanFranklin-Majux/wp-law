...
<div class="<?php echo $post->css_classes('small') ?>">
	...
	<?php if ($post->has_thumbnail_image()): ?>
		<img class="thumbnail video-light-box" data-video-url="<?php echo $url ?>" data-video-id="" data-video-ratio="<?php echo $ratio ?>" src="<?php echo $post->thumbnail_image_url ?>" alt="<?php echo $post->thumbnail_image_alt ?>" />
	<?php else: ?>
		<img class="thumbnail video-light-box" data-video-url="<?php echo $url ?>" data-video-id="" data-video-ratio="<?php echo $ratio ?>" src="<?php echo $thumbnail ?>" alt="<?php echo $post->thumbnail_image_alt ?>" />
	<?php endif; ?>
