...
$TMF_Shortcodes['posts'] = array(
	'name' => __( 'Posts', 'tmf-shortcodes' ),
	'type' => 'single',
	'group' => 'content',
	'post_type'	=> 'post',
	'atts' => array(
		...
		'template' => array(
			...
			'desc' => __( '<b>Do not change this field value if you do not understand description below.</b><br/>Default templates is placed under the framework/blocks/post-types/post/ directory (templates folder). You can copy it under your theme directory and modify as you want. You can use following default templates that already available in the framework directory:<br/><b%value>medium</b> - posts loop<br/><b%value>small</b> - posts loop with thumbnail and title<br/><b%value>large</b> - single post template', 'tmf-shortcodes' )
		),
		'include' => array(
			'default' => '',
	...
	'content' => __( 'Posts', 'tmf-shortcodes' ),
	'desc' => __( 'Posts Post Type', 'tmf-shortcodes' ),
);