...
$TMF_Shortcodes['attorneys'] = array(
	'name' => __( 'Attorneys', 'tmf-shortcodes' ),
	'type' => 'single',
	'group' => 'content',
	'post_type'	=> 'attorney',
	'atts' => array(
		'taxonomy' => array(
			'default' => 'attorney-categories',
		...
		'template' => array(
			...
			'desc' => __( '<b>Do not change this field value if you do not understand description below.</b><br/>Default templates is placed under the framework/blocks/post-types/attorney/ directory (templates folder). You can copy it under your theme directory and modify as you want. You can use following default templates that already available in the framework directory:<br/><b%value>medium</b> - posts loop<br/><b%value>small</b> - posts loop with thumbnail and title<br/><b%value>large</b> - single post template', 'tmf-shortcodes' )
		),
		'include' => array(
			'default' => '',
	...
	'content' => __( 'Attorneys', 'tmf-shortcodes' ),
	'desc' => __( 'Attorneys Post Type', 'tmf-shortcodes' ),
);