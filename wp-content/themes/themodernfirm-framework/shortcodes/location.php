...
$TMF_Shortcodes['locations'] = array(
	'name' => __( 'Locations', 'tmf-shortcodes' ),
	'type' => 'single',
	'group' => 'content',
	'post_type'	=> 'location',
	'atts' => array(
		...
		'limit' => array(
			...
			'step' => 1,
			'default' => '',
			'name' => __( 'Number of Locationss', 'tmf-shortcodes' ),
			'desc' => __( 'Specify number of locations that you want to show. Enter -1 to get all locations', 'tmf-shortcodes' )
		),
		'random' => array(
			'type' => 'select',
			'values' => array(
	...
	'content' => __( 'Locations', 'tmf-shortcodes' ),
	'desc' => __( 'Locations Post Type', 'tmf-shortcodes' ),
);