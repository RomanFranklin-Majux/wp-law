...
/********** Shortcode: Practice-Area *************************************************************/

$TMF_Shortcodes['practice-areas'] = array(
	'name' => __( 'Practice Areas', 'tmf-shortcodes' ),
	'type' => 'single',
	'group' => 'content',
	'post_type'	=> 'practice-area',
	'atts' => array(
		'taxonomy' => array(
			'default' => 'practice-area-categories',
		...
		'template' => array(
			...
			'desc' => __( '<b>Do not change this field value if you do not understand description below.</b><br/>Default templates is placed under the framework/blocks/post-types/practice-area/ directory (templates folder). You can copy it under your theme directory and modify as you want. You can use following default templates that already available in the framework directory:<br/><b%value>medium</b> - posts loop<br/><b%value>small</b> - posts loop with thumbnail and title<br/><b%value>large</b> - single post template', 'tmf-shortcodes' )
		),
		'include' => array(
			'default' => '',
		...
		'limit' => array(
			...
			'step' => 1,
			'default' => '',
			'name' => __( 'Number of Practice Areas', 'tmf-shortcodes' ),
			'desc' => __( 'Specify number of practice areas that you want to show. Enter -1 to get all practice areas', 'tmf-shortcodes' )
		),
		'random' => array(
			'type' => 'select',
			'values' => array(
		...
		'meta_key' => array(
			...
			'desc' => __( 'Enter meta key name to show practice areas that have this key', 'tmf-shortcodes' )
		),
		'offset' => array(
			'type' => 'number',
			'min' => 0,
			...
			'desc' => __( 'Specify offset to start practice areas loop not from first post', 'tmf-shortcodes' )
		),
		'order' => array(
			'type' => 'select',
			'values' => array(
		...
		'orderby' => array(
			...
			'desc' => __( 'Order practice areas by', 'tmf-shortcodes' )
		),
		'exclude' => array(
			'default' => '',
			'name' => __( 'Exclude', 'tmf-shortcodes' ),
			'desc' => __( 'Enter comma separated ID\'s of the practice areas that you don\'t want to show', 'tmf-shortcodes' )
		),
	),

	'content' => __( 'Practice Areas', 'tmf-shortcodes' ),
	'desc' => __( 'Practice Areas Post Type', 'tmf-shortcodes' ),
);