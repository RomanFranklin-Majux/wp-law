...
/********** Shortcode: Representative Casess *************************************************************/

$TMF_Shortcodes['representative-cases'] = array(
	'name' => __( 'Representative Casess', 'tmf-shortcodes' ),
	'type' => 'single',
	'group' => 'content',
	'post_type'	=> 'representative-case',
	'atts' => array(
		'taxonomy' => array(
			'default' => 'representative-case-categories',
		...
		'template' => array(
			...
			'desc' => __( '<b>Do not change this field value if you do not understand description below.</b><br/>Default templates is placed under the framework/blocks/post-types/representative-case/ directory (templates folder). You can copy it under your theme directory and modify as you want. You can use following default templates that already available in the framework directory:<br/><b%value>medium</b> - posts loop<br/><b%value>small</b> - posts loop with thumbnail and title<br/><b%value>large</b> - single post template', 'tmf-shortcodes' )
		),
		'include' => array(
			'default' => '',
	...
	'content' => __( 'Representative Casess', 'tmf-shortcodes' ),
	'desc' => __( 'Representative Casess Post Type', 'tmf-shortcodes' ),
);